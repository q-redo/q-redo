...
class TopBar extends Component {
  ...
  componentWillReceiveProps() {
    if (this.props.user) {
      if (this.props.user !== {}) {
        this.setState({
          cohort: `DM ${this.props.user.cohort_id}`,
          campus: this.props.user.campus_id
        })
      }
    }
  }
  ...
  handleColor(color) {
    ...
    this.props.changeTheme([
      hexToComplimentary(color),
      shadeColor2(color, -0.4),
      shadeColor2(color, -0.8)
    ])
  }
      ...
      <div className="topBar-main-container flexed">
        <div className="topBar-left">
          ...
          {this.state.campus === 1 ? (
            ...
            <p>DALLAS</p>
          ) : this.state.campus === 20 ? (
            <p>DENVER</p>
          ) : this.state.campus === 23 ? (
            <p>HOUSTON</p>
          ) : null}
